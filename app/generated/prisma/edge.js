...
const config = {
  "generator": {
    ...
    "output": {
      "value": "D:\\TMS_Training\\TMS_Tan_Traning_NextJS\\app\\generated\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://postgres:jzGJzcMpfHNnBtFJZyufaqoBoWuDfNAV@metro.proxy.rlwy.net:24257/railway"
      }
    }
  },
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"../app/generated/prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel Item {\n  id          Int      @id @default(autoincrement())\n  title       String\n  description String\n  createdAt   DateTime @default(now())\n}\n",
  "inlineSchemaHash": "e8e8a103ae56a2682e5571300f69beb6c15c178e1a5248ae3ae0e45ebc1d2da0",
  "copyEngine": true
}
config.dirname = '/'
